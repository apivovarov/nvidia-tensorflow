...
inline bool DebugOptions_ShapeChecks_Parse(
    const std::string& name, DebugOptions_ShapeChecks* value) {
...
class DebugOptions :
 ...
 public:
  ...
  static inline bool ShapeChecks_Parse(const std::string& name,
      ShapeChecks* value) {
  ...
  enum : int {
    ...
    kXlaGpuPersistentCacheDirFieldNumber = 179,
    ...
    kXlaCpuUseJitrtFieldNumber = 177,
    ...
    kXlaGpuBefExecutableFieldNumber = 161,
    ...
    kXlaGpuBefThunkFieldNumber = 162,
    kXlaGpuJitrtExecutableFieldNumber = 169,
    kXlaGpuEnableSharedConstantsFieldNumber = 165,
    kXlaGpuEnableCublasltFieldNumber = 166,
    kXlaGpuSimplifyScattersFieldNumber = 176,
    kXlaGpuSimplifyGathersFieldNumber = 178,
    ...
    kXlaGpuEnableRedzoneCheckFieldNumber = 180,
  };
  ...
  // string xla_gpu_persistent_cache_dir = 179;
  void clear_xla_gpu_persistent_cache_dir();
  const std::string& xla_gpu_persistent_cache_dir() const;
  void set_xla_gpu_persistent_cache_dir(const std::string& value);
  void set_xla_gpu_persistent_cache_dir(std::string&& value);
  void set_xla_gpu_persistent_cache_dir(const char* value);
  void set_xla_gpu_persistent_cache_dir(const char* value, size_t size);
  std::string* mutable_xla_gpu_persistent_cache_dir();
  std::string* release_xla_gpu_persistent_cache_dir();
  void set_allocated_xla_gpu_persistent_cache_dir(std::string* xla_gpu_persistent_cache_dir);
  ...
  // bool xla_cpu_use_jitrt = 177;
  void clear_xla_cpu_use_jitrt();
  bool xla_cpu_use_jitrt() const;
  void set_xla_cpu_use_jitrt(bool value);
  ...
  void clear_xla_gpu_jitrt_executable();
  bool xla_gpu_jitrt_executable() const;
  void set_xla_gpu_jitrt_executable(bool value);
  ...
  // bool xla_gpu_simplify_scatters = 176;
  void clear_xla_gpu_simplify_scatters();
  bool xla_gpu_simplify_scatters() const;
  void set_xla_gpu_simplify_scatters(bool value);

  // bool xla_gpu_simplify_gathers = 178;
  void clear_xla_gpu_simplify_gathers();
  bool xla_gpu_simplify_gathers() const;
  void set_xla_gpu_simplify_gathers(bool value);
  ...
  // bool xla_gpu_enable_redzone_check = 180;
  void clear_xla_gpu_enable_redzone_check();
  bool xla_gpu_enable_redzone_check() const;
  void set_xla_gpu_enable_redzone_check(bool value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr xla_gpu_persistent_cache_dir_;
  ...
  bool xla_gpu_jitrt_executable_;
  bool xla_gpu_enable_shared_constants_;
  bool xla_gpu_enable_cublaslt_;
  bool xla_gpu_simplify_scatters_;
  bool xla_gpu_simplify_gathers_;
  ...
  bool xla_gpu_enable_redzone_check_;
...
// bool xla_cpu_use_jitrt = 177;
inline void DebugOptions::clear_xla_cpu_use_jitrt() {
  xla_cpu_use_jitrt_ = false;
}
inline bool DebugOptions::xla_cpu_use_jitrt() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_cpu_use_jitrt)
  return xla_cpu_use_jitrt_;
}
inline void DebugOptions::set_xla_cpu_use_jitrt(bool value) {
  
  xla_cpu_use_jitrt_ = value;
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_cpu_use_jitrt)
}
...
// bool xla_gpu_simplify_scatters = 176;
inline void DebugOptions::clear_xla_gpu_simplify_scatters() {
  xla_gpu_simplify_scatters_ = false;
}
inline bool DebugOptions::xla_gpu_simplify_scatters() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_simplify_scatters)
  return xla_gpu_simplify_scatters_;
}
inline void DebugOptions::set_xla_gpu_simplify_scatters(bool value) {
  
  xla_gpu_simplify_scatters_ = value;
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_simplify_scatters)
}

// bool xla_gpu_simplify_gathers = 178;
inline void DebugOptions::clear_xla_gpu_simplify_gathers() {
  xla_gpu_simplify_gathers_ = false;
}
inline bool DebugOptions::xla_gpu_simplify_gathers() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_simplify_gathers)
  return xla_gpu_simplify_gathers_;
}
inline void DebugOptions::set_xla_gpu_simplify_gathers(bool value) {
  
  xla_gpu_simplify_gathers_ = value;
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_simplify_gathers)
}
...
inline void DebugOptions::clear_xla_gpu_all_reduce_combine_threshold_bytes() {
  xla_gpu_all_reduce_combine_threshold_bytes_ = PROTOBUF_LONGLONG(0);
}
...
inline void DebugOptions::clear_xla_dump_hlo_pipeline_re() {
  xla_dump_hlo_pipeline_re_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline void DebugOptions::set_xla_dump_hlo_pipeline_re(const std::string& value) {
  ...
  xla_dump_hlo_pipeline_re_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
...
inline void DebugOptions::set_xla_dump_hlo_pipeline_re(const char* value) {
  ...
  xla_dump_hlo_pipeline_re_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void DebugOptions::set_xla_dump_hlo_pipeline_re(const char* value, size_t size) {
  ...
  xla_dump_hlo_pipeline_re_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* DebugOptions::mutable_xla_dump_hlo_pipeline_re() {
  ...
  return xla_dump_hlo_pipeline_re_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* DebugOptions::release_xla_dump_hlo_pipeline_re() {
  ...
  return xla_dump_hlo_pipeline_re_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void DebugOptions::set_allocated_xla_dump_hlo_pipeline_re(std::string* xla_dump_hlo_pipeline_re) {
  ...
  xla_dump_hlo_pipeline_re_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), xla_dump_hlo_pipeline_re);
...
// bool xla_gpu_jitrt_executable = 169;
inline void DebugOptions::clear_xla_gpu_jitrt_executable() {
  xla_gpu_jitrt_executable_ = false;
}
inline bool DebugOptions::xla_gpu_jitrt_executable() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_jitrt_executable)
  return xla_gpu_jitrt_executable_;
}
inline void DebugOptions::set_xla_gpu_jitrt_executable(bool value) {
  
  xla_gpu_jitrt_executable_ = value;
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_jitrt_executable)
}

// int64 xla_gpu_nccl_termination_timeout_seconds = 163;
inline void DebugOptions::clear_xla_gpu_nccl_termination_timeout_seconds() {
  xla_gpu_nccl_termination_timeout_seconds_ = PROTOBUF_LONGLONG(0);
}
...
inline void DebugOptions::clear_xla_gpu_redzone_scratch_max_megabytes() {
  xla_gpu_redzone_scratch_max_megabytes_ = PROTOBUF_LONGLONG(0);
}
...
// string xla_gpu_persistent_cache_dir = 179;
inline void DebugOptions::clear_xla_gpu_persistent_cache_dir() {
  xla_gpu_persistent_cache_dir_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& DebugOptions::xla_gpu_persistent_cache_dir() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_persistent_cache_dir)
  return xla_gpu_persistent_cache_dir_.GetNoArena();
}
inline void DebugOptions::set_xla_gpu_persistent_cache_dir(const std::string& value) {
  
  xla_gpu_persistent_cache_dir_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_persistent_cache_dir)
}
inline void DebugOptions::set_xla_gpu_persistent_cache_dir(std::string&& value) {
  
  xla_gpu_persistent_cache_dir_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xla.DebugOptions.xla_gpu_persistent_cache_dir)
}
inline void DebugOptions::set_xla_gpu_persistent_cache_dir(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  xla_gpu_persistent_cache_dir_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:xla.DebugOptions.xla_gpu_persistent_cache_dir)
}
inline void DebugOptions::set_xla_gpu_persistent_cache_dir(const char* value, size_t size) {
  
  xla_gpu_persistent_cache_dir_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xla.DebugOptions.xla_gpu_persistent_cache_dir)
}
inline std::string* DebugOptions::mutable_xla_gpu_persistent_cache_dir() {
  
  // @@protoc_insertion_point(field_mutable:xla.DebugOptions.xla_gpu_persistent_cache_dir)
  return xla_gpu_persistent_cache_dir_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* DebugOptions::release_xla_gpu_persistent_cache_dir() {
  // @@protoc_insertion_point(field_release:xla.DebugOptions.xla_gpu_persistent_cache_dir)
  
  return xla_gpu_persistent_cache_dir_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void DebugOptions::set_allocated_xla_gpu_persistent_cache_dir(std::string* xla_gpu_persistent_cache_dir) {
  if (xla_gpu_persistent_cache_dir != nullptr) {
    
  } else {
    
  }
  xla_gpu_persistent_cache_dir_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), xla_gpu_persistent_cache_dir);
  // @@protoc_insertion_point(field_set_allocated:xla.DebugOptions.xla_gpu_persistent_cache_dir)
}

// bool xla_gpu_enable_redzone_check = 180;
inline void DebugOptions::clear_xla_gpu_enable_redzone_check() {
  xla_gpu_enable_redzone_check_ = false;
}
inline bool DebugOptions::xla_gpu_enable_redzone_check() const {
  // @@protoc_insertion_point(field_get:xla.DebugOptions.xla_gpu_enable_redzone_check)
  return xla_gpu_enable_redzone_check_;
}
inline void DebugOptions::set_xla_gpu_enable_redzone_check(bool value) {
  
  xla_gpu_enable_redzone_check_ = value;
  // @@protoc_insertion_point(field_set:xla.DebugOptions.xla_gpu_enable_redzone_check)
}

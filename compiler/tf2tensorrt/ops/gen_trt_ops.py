...
def initialize_trt_resource(resource_handle, filename, max_cached_engines_count=1, dla_core=-1, dla_fallback_layers=-1, name=None):
  r"""TODO: add doc.
  ...
  Args:
    ...
    dla_core: An optional `int`. Defaults to `-1`.
    dla_fallback_layers: An optional `int`. Defaults to `-1`.
    name: A name for the operation (optional).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        "max_cached_engines_count", max_cached_engines_count, "dla_core",
        dla_core, "dla_fallback_layers", dla_fallback_layers)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
    ...
    try:
      _result = _dispatcher_for_initialize_trt_resource(
          (resource_handle, filename, max_cached_engines_count, dla_core,
          dla_fallback_layers, name,), None)
      if _result is not NotImplemented:
        return _result
      return initialize_trt_resource_eager_fallback(
          resource_handle, filename,
          max_cached_engines_count=max_cached_engines_count,
          dla_core=dla_core, dla_fallback_layers=dla_fallback_layers,
          name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
      _result = _dispatch.dispatch(
            initialize_trt_resource, (), dict(resource_handle=resource_handle,
                                              ...
                                              max_cached_engines_count=max_cached_engines_count,
                                              dla_core=dla_core,
                                              dla_fallback_layers=dla_fallback_layers,
                                              name=name)
          )
      if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
        return _result
  ...
  if dla_core is None:
    dla_core = -1
  dla_core = _execute.make_int(dla_core, "dla_core")
  if dla_fallback_layers is None:
    dla_fallback_layers = -1
  dla_fallback_layers = _execute.make_int(dla_fallback_layers, "dla_fallback_layers")
  try:
    _, _, _op, _outputs = _op_def_library._apply_op_helper(
...
def initialize_trt_resource_eager_fallback(resource_handle, filename, max_cached_engines_count, dla_core, dla_fallback_layers, name, ctx):
  if max_cached_engines_count is None:
    max_cached_engines_count = 1
  max_cached_engines_count = _execute.make_int(max_cached_engines_count, "max_cached_engines_count")
  if dla_core is None:
  ...
  _attrs = ("max_cached_engines_count", max_cached_engines_count, "dla_core",
  dla_core, "dla_fallback_layers", dla_fallback_layers)
...
def trt_engine_op(in_tensor, serialized_segment, OutT, workspace_size_bytes, precision_mode, segment_func="", input_shapes=[], output_shapes=[], max_cached_engines_count=1, max_batch_size=1, enable_sparse_compute=True, dla_core=-1, dla_fallback_layers=-1, calibration_data="", use_calibration=True, segment_funcdef_name="", cached_engine_batches=[], fixed_input_size=True, static_engine=True, profile_strategy="", use_explicit_precision=False, name=None):
  ...
  Args:
    ...
    enable_sparse_compute: An optional `bool`. Defaults to `True`.
    dla_core: An optional `int`. Defaults to `-1`.
    dla_fallback_layers: An optional `int`. Defaults to `-1`.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        workspace_size_bytes, "enable_sparse_compute", enable_sparse_compute,
        "precision_mode", precision_mode, "dla_core", dla_core,
        "dla_fallback_layers", dla_fallback_layers, "calibration_data",
        calibration_data, "use_calibration", use_calibration,
        "segment_funcdef_name", segment_funcdef_name, "cached_engine_batches",
        cached_engine_batches, "fixed_input_size", fixed_input_size,
        "static_engine", static_engine, "profile_strategy", profile_strategy,
    ...
    try:
      _result = _dispatcher_for_trt_engine_op(
          ...
          max_cached_engines_count, max_batch_size, enable_sparse_compute,
          dla_core, dla_fallback_layers, calibration_data, use_calibration,
          segment_funcdef_name, cached_engine_batches, fixed_input_size,
          static_engine, profile_strategy, use_explicit_precision, name,),
          None)
      if _result is not NotImplemented:
        return _result
      return trt_engine_op_eager_fallback(
          ...
          enable_sparse_compute=enable_sparse_compute,
          precision_mode=precision_mode, dla_core=dla_core,
          dla_fallback_layers=dla_fallback_layers,
          calibration_data=calibration_data, use_calibration=use_calibration,
    ...
    _result = _dispatcher_for_trt_engine_op(
        ...
        dla_core, dla_fallback_layers, calibration_data, use_calibration,
        segment_funcdef_name, cached_engine_batches, fixed_input_size,
        static_engine, profile_strategy, use_explicit_precision, name,), None)
    if _result is not NotImplemented:
      return _result
  # Add nodes to the TensorFlow graph.
  ...
  if enable_sparse_compute is None:
    enable_sparse_compute = True
  enable_sparse_compute = _execute.make_bool(enable_sparse_compute, "enable_sparse_compute")
  if dla_core is None:
    dla_core = -1
  dla_core = _execute.make_int(dla_core, "dla_core")
  if dla_fallback_layers is None:
  ...
  if _execute.must_record_gradient():
    _attrs = ("serialized_segment", _op.get_attr("serialized_segment"),
              ...
              _op._get_attr_int("workspace_size_bytes"),
              "enable_sparse_compute",
              _op._get_attr_bool("enable_sparse_compute"), "precision_mode",
              _op.get_attr("precision_mode"), "dla_core",
              _op._get_attr_int("dla_core"), "dla_fallback_layers",
              _op._get_attr_int("dla_fallback_layers"), "calibration_data",
...
def trt_engine_op_eager_fallback(in_tensor, serialized_segment, OutT, workspace_size_bytes, precision_mode, segment_func, input_shapes, output_shapes, max_cached_engines_count, max_batch_size, enable_sparse_compute, dla_core, dla_fallback_layers, calibration_data, use_calibration, segment_funcdef_name, cached_engine_batches, fixed_input_size, static_engine, profile_strategy, use_explicit_precision, name, ctx):
  ...
  "workspace_size_bytes", workspace_size_bytes, "enable_sparse_compute",
  enable_sparse_compute, "precision_mode", precision_mode, "dla_core",
  dla_core, "dla_fallback_layers", dla_fallback_layers, "calibration_data",
  calibration_data, "use_calibration", use_calibration,
  "segment_funcdef_name", segment_funcdef_name, "cached_engine_batches",
  cached_engine_batches, "fixed_input_size", fixed_input_size,
  "static_engine", static_engine, "profile_strategy", profile_strategy,
